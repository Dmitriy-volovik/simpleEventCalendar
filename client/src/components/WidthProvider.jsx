 ...
 */
function WidthProvider(ComposedComponent, columnsCount, columnMaxWidth) {
  var _class, _temp2;
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    function WidthProvider() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WidthProvider.__proto__ || Object.getPrototypeOf(WidthProvider)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        width: 1280
        ...
        // debugger;
        if (node instanceof HTMLElement) _this.setState({ width: Math.min(node.offsetWidth, columnMaxWidth * columnsCount) });
